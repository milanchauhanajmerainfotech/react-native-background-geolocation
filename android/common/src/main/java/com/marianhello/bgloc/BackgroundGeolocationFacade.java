...
public class BackgroundGeolocationFacade {
    ...
    public void start() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            checkPermission(permissionManager, PERMISSIONSOVER);
        } else {
            checkPermission(permissionManager, PERMISSIONS);
        }
    }

    public void checkPermission(PermissionManager permissionManager, String[] PERMISSIONSTYPE) {
